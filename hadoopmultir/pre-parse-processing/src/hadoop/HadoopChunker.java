...
//					scala.collection.JavaConversions.seqAsJavaList(chunker.chunkPostagged(scala.collection.JavaConversions.asScalaIterable(posTokens).toSeq()));

List<ChunkedToken> chunkedTokens =
					scala.collection.JavaConversions.seqAsJavaList(chunker.chunkPostagged(scala.collection.JavaConversions.collectionAsScalaIterable(posTokens).toSeq()));
