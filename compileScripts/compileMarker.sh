...
javac -classpath /mnt/a99/d0/aman/sgmtp/opennlplib/commons-lang-2.6.jar:/mnt/b100/d0/hadoop/hadoop-0.20.2-cdh3u6/hadoop-core-0.20.2-cdh3u6.jar -d Hadoop_Marker/bin Hadoop_Marker/src/marker/*.java 
jar -cvf marker.jar -C Hadoop_Marker/bin .
